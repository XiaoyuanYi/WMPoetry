...
def parse_args():
    ...
    parser.add_argument("-i", "--inp", type=str, help="The input file path, for file generation.")
    parser.add_argument("-o", "--out", type=str, help="The output file path, for file generation.")
    parser.add_argument("-t", "--type",  required=True, type=str, choices=['single', 'file'], 
        help='The mode. single: just generate one single poem; file: generate by the input file.')
    parser.add_argument("-m", "--model", type=str, help="The checkpoint path. If none, just use the newest checkpoint.")
    parser.add_argument("-b", "--bsize",  required=True, type=int, help="The beam size.")
...
class GeneratorUI(object):
    ...
    def generate_one(self):
        while True:
            ...
            pattern_id = int(input("please select genre pattern > "))
            yun = int(input("please input yun type> "))
